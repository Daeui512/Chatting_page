...
public class MessageVO {
	...
	public MessageVO(String message_id, String message_sender, String message_receiver, String message_content,
			Date message_sendTime, Date message_readTime, String cHATROOM_chatroom_id, String uSER_user_id,
			String tUTOR_USER_user_id, int cLASS_class_id, String user_profileImagePath,
			String receiver_user_profileImagePath, String user_name, String receiver_user_name, String class_name,
			int class_id, String tUTOR_tutor_id, String tutor_name, String tuti_id, int unReadCount) {
		super();
