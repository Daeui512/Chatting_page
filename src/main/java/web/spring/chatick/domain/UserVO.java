...
public class UserVO{
	...
	public UserVO(String user_id, String user_email, String user_name, String user_password,
			String user_profileImagePath, int user_sex, String user_birth, String user_job, String user_phoneNumber,
			String user_authCode, String user_authStatus, String user_isTutor, String user_status, String pageNumber,
			String rnum, Date user_log, int ages, int age_count, int user_isAdmin, int unReadCount) {
		super();
